...
async function pruebaPaso6Dinamico() {
    ...
    try {
        ...
        if (currentUrl.includes('/paso/5')) {
            ...
            await driver.executeScript(
                "document.getElementById('observaciones').value='Controles dentro de especificación';"
            );
        ...
        if (!currentUrl.includes('/paso/6')) {
            ...
            console.log('No llegó al Paso 6');
            console.log('URL actual:', currentUrl);
            return;
        }

        console.log('Paso 6 detectado');
        ...
        await driver.executeScript(
            "document.getElementById('observaciones').value='Retiro realizado correctamente sin desviaciones.';"
        );
        ...
        if (finalUrl.includes('/paso/7') || finalUrl.includes('/final')) {
            console.log('Paso 6 completado correctamente');
        } else {
            console.log('Fallo en avance desde Paso 6');
